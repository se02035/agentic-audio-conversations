...
from tts_podcast_creator.logic.translator import (
...
class TestPodcastTranslator:
    """Test suite for PodcastTranslator EU regional translation."""
    ...
    @patch("tts_podcast_creator.logic.translator.translate_v3.TranslationServiceClient")
    def test_client_initialization_with_eu_endpoint(
        ...
        translator = PodcastTranslator(project_id="test-proj", credentials=mock_credentials)
    ...
    def test_voice_mapping_fallback_logic(self, mock_credentials: MagicMock) -> None:
        ...
        with patch("tts_podcast_creator.logic.translator.translate_v3.TranslationServiceClient"):
            translator = PodcastTranslator(project_id="test-proj", credentials=mock_credentials)
